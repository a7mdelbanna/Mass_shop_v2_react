        ...
        >
          <SidebarMenuSub>
            ...
            <SidebarMenuSubItem>
              ...
              >
                <Link to="/dashboard/products/categories/main" className="flex items-center">
            ...
            <SidebarMenuSubItem>
              <SidebarMenuSubButton
                asChild
                isActive={isExactActive('/dashboard/products/categories/sub')}
              >
                <Link to="/dashboard/products/categories/sub" className="flex items-center">
                  <Layers className="h-4 w-4 mr-2" />
